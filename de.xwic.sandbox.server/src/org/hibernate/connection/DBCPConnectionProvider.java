 ...
 * 
 * <br>
 * All DBCP properties are also supported by using the hibernate.dbcp prefix. A complete list can be found on the DBCP configuration page:
 * <a href="http://jakarta.apache.org/commons/dbcp/configuration.html">http://jakarta.apache.org/commons/dbcp/configuration.html</a>. <br>
 * 
 * <pre>
 * Example:
 ...
 * 
 * <p>
 * More information about configuring/using DBCP can be found on the <a href="http://jakarta.apache.org/commons/dbcp/">DBCP website</a>.
 * There you will also find the DBCP wiki, mailing lists, issue tracking and other support facilities
 * </p>
 * 
...
public class DBCPConnectionProvider implements ConnectionProvider {
	...
	public void configure(Properties props) throws HibernateException {
		try {
			log.info("Configure DBCPConnectionProvider");
		...
		log.info("Configure DBCPConnectionProvider complete");
	}
	...
	public void close() throws HibernateException {
		log.info("Close DBCPConnectionProvider");
		logStatistics();
		try {
			if (ds != null) {
				ds.close();
	...
	protected void logStatistics() {
		if (log.isDebugEnabled()) {
			log.debug("active: " + ds.getNumActive() + " (max: " + ds.getMaxActive() + ")   " + "idle: " + ds.getNumIdle() + "(max: "
					+ ds.getMaxIdle() + ")");
		}
	}

	/**
	 * returns supportAggressiveRelease.
	 * 
	 * @return
	 */
