...
public class StartModelConfig {
	...
	public static void register(DAOFactory factory) {
		factory.registerDao(IQuickLaunchDAO.class, new QuickLaunchDAO());
	}
