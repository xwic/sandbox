 ...
 *******************************************************************************/
package de.xwic.sandbox.start.ui;
...
import de.xwic.sandbox.start.ui.home.HomeSubmodule;
...
public class StartModule extends Module {
	...
	protected List<SubModule> createSubModules(Site site) {
		...
		if (ConfigurationUtil.hasAccess(SandboxModelConfig.SMOD_GET_STARTED_HOME)) {		
