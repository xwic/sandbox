...
import de.xwic.sandbox.start.ui.home.ql.QuickLaunchConfigDialog;
...
public class QuickLaunchPanel extends ControlContainer {
	 ...
	 * @param name
	 */
	public QuickLaunchPanel(IControlContainer container, String name) {
		super(container, name);

		site = ExtendedApplication.getInstance(this).getSite();
		model = new QuickLaunchModel();
		model.initUser(site);
	...
	protected void onConfigCards() {
		...
		QuickLaunchConfigDialog qlConfDlg = new QuickLaunchConfigDialog(site, model);
