...
public class EntityDisplayListModel extends ListModel {
	...
	public boolean canDelete() {
		boolean hasRight = DAOSystem.getSecurityManager().hasRight(entityClass.getName(), ApplicationData.SECURITY_ACTION_DELETE);
		return hasRight;
	}
	...
	public boolean canEdit() {
		boolean hasRight = DAOSystem.getSecurityManager().hasRight(entityClass.getName(), ApplicationData.SECURITY_ACTION_UPDATE);
		return hasRight;
	}
	...
	public boolean canNew() {
		boolean hasRight = DAOSystem.getSecurityManager().hasRight(entityClass.getName(), ApplicationData.SECURITY_ACTION_CREATE);
		return hasRight;
	}
