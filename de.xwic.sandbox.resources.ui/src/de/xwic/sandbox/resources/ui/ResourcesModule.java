 ...
 *******************************************************************************/
package de.xwic.sandbox.resources.ui;
...
import de.xwic.sandbox.resources.ui.people.PeopleSubmodule;
...
public class ResourcesModule extends Module {
	 ...
	 * @param site
	 */
	public ResourcesModule(Site site) {
		super(site);
		setTitle("Resources");
		setKey(getModuleKey());
	}
	...
	protected List<SubModule> createSubModules(Site site) {
		...
		if (ConfigurationUtil.hasAccess(SandboxModelConfig.SMOD_RESOURCES_EMPLOYEE)) {		
			list.add(new PeopleSubmodule(site));
		}
