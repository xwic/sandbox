...
public class PeopleEditorPage extends EntityEditorPage {
	 ...
	 * @param model
	 */
	public PeopleEditorPage(IControlContainer container, String name, EditorModel model) {
	...
	protected void createControls(EditorModel model) {
		new PeopleEditorView(this, "peopleEditorView", model);
	}
	...
	protected String getPageSubtitle() {
		return "Edit the details for this Employee";
	}
