 ...
 *
 */
public class PeopleEditorCreator extends AbstractEntityEditorCreator {
	...
	protected IControl getEditorPage(Site site, EditorModel editorModel) {
		return new PeopleEditorPage(site.getContentContainer(), null, editorModel);
	}
	...
	protected EditorModel getEditorModel(IEntity entity, IEntity baseEntity) {
		return new PeopleEditorModel(entity);
	}
}
