 ...
 *
 */
public class CampaignSubmodule extends SandboxSubModule {

	/**
	 * @param site
	 */
	public CampaignSubmodule(Site site) {
		super(site);
		setTitle("Campaign");

		setFullTitle("Campaign Overview");
	...
	public IControl createControls(IControlContainer container) {
		return new CampaignPage(container, "campaignPage");
	}
