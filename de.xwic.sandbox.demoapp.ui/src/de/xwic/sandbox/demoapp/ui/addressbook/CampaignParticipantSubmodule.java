 ...
 *
 */
public class CampaignParticipantSubmodule extends SandboxSubModule {

	/**
	 * @param site
	 */
	public CampaignParticipantSubmodule(Site site) {
		super(site);
		setTitle("Campaign Participant");

		setFullTitle("Campaign Participant Overview");
		setDescription("Manage all campaign participants related to you.");
	...
	public IControl createControls(IControlContainer container) {
		return new CampaignParticipantPage(container, "campaignParticipantPage");
	}
	...
	public String getKey() {
		return "campaignParticipantSubmodule";
	}
