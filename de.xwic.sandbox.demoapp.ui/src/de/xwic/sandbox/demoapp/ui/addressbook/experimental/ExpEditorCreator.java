 ...
 *
 */
public class ExpEditorCreator extends AbstractEntityEditorCreator {
	...
	protected IControl getEditorPage(Site site, EditorModel editorModel) {
		return new ExperimentalEditorPage(site.getContentContainer(), null, editorModel);
	}
	...
	protected EditorModel getEditorModel(IEntity entity, IEntity baseEntity) {
		return new ExpEditorModel(entity);
	}
