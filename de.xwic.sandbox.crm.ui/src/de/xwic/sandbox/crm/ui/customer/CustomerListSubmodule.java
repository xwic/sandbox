 ...
 */
public class CustomerListSubmodule extends SubModule {

	public final static String SCOPE_SMOD_CRM_CUSTOMERS = "SMOD_CRM_CUSTOMERS";
	private final static ImageRef MODULE_ICON = new ImageRef("images/module_icons/address_book.png");
	
	/**
	 * @param site
	 */
	public CustomerListSubmodule(Site site) {
		super(site);
		setTitle("Customers");
		setDescription("List of customers");
		setDefaultQuickLaunch(true);
		setFullTitle("Customer List");
	...
	public IControl createControls(IControlContainer container) {
		return new BasicListPage(container, "listPage", ICustomer.class);
	}
